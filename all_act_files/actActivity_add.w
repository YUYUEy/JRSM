...
<div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents1">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5" style="height:40px;">
   ...
   <!-- <div component="$UI/system/components/justep/row/row" class="x-row" xid="row12" style="display: none;">
   ...
   <div id="checkbox_group2" component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit8" style="margin-left:105px;line-height:18px;">
   <!-- <label class="x-label" xid="label7" style="text-align:right;width:199px;"><![CDATA[i18n{itemCatalogs}]]></label> -->
   <label class="x-label" xid="label7" style="text-align:right;width:197px;margin-right:5px;margin-bottom:80px;">i18n{itemCatalogs}</label><span component="$UI/system/components/justep/select/checkboxGroup" class="x-checkboxs x-edit" xid="checkboxGroup2" bind-itemset="queryItemCatalogsData" bind-itemsetValue='ref("catalogCode")' bind-itemsetLabel='ref("catalogName")' bind-ref='$model.addActivityData.ref("bdItemCatalogs")' onChange="checkboxGroup2Change"></span></div></div></div>
  </div>
   </div></div>
