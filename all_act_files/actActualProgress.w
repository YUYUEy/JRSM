...
<div component="$UI/system/components/justep/row/row" class="x-row" xid="row5" style="padding:8px 0px 8px 0px;width:1200px;">
   ...
   <input id="targetMonth" class="form-control date x-iDatetimePicker" component="$UI/system/components/jrsm/iDatetimePicker/iDatetimePicker" xid="iDatetimePicker1" format="YYYY-MM" onOkfun="iDatetimePicker1Okfun" style="height:26px;width:130px;" readonly="true"></input></div>
  ...
  <div xid="div3" style="overflow:hidden;height:110px;border-bottom:1px solid #eee;width:1150px;" class="the_condition"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row13" style="height:30px;">
   <div class="x-col" xid="col31"><span xid="span12" style="margin-top:5px;margin-left:15px;float:left;"><![CDATA[i18n{searchCondition}]]></span><a component="$UI/system/components/justep/button/button" class="btn btn-info btn-only-icon" label="button" xid="button6" icon="linear linear-database" bind-click="button6Click" style="margin-left:10px;float:left;height:20px;line-height:16px;margin-top:5px;">
   <i xid="i6" class="linear linear-database"></i>
  ...
  <div class="x-col" xid="col7"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit3">
   ...
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch3" config="org_area" displayAttr="orgName" valueAttr="orgCode" onBeforeQuery="iQuickSearch3BeforeQuery" onChooseAfter="iQuickSearch3ChooseAfter" onDeleteAfter="iQuickSearch3DeleteAfter" bind_refData='$model.queryBdOrgData.ref("unit2Code")'></div></div></div><div class="x-col" xid="col6"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit5">
   <label class="x-label" xid="label3" style="text-align:right;padding-right:5px;"><![CDATA[i18n{area}]]></label>
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch4" config="org_area" displayAttr="orgName" valueAttr="orgCode" onBeforeQuery="iQuickSearch4BeforeQuery" bind_refData='$model.queryBdOrgData.ref("unit3Code")' onDeleteAfter="iQuickSearch4DeleteAfter"></div></div></div><div class="x-col" xid="col5"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit2">
   <label class="x-label" xid="label6" style="text-align:right;padding-right:5px;"><![CDATA[i18n{branch}]]></label>
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch1" config="org_area" displayAttr="orgName" valueAttr="orgCode" onBeforeQuery="iQuickSearch1BeforeQuery" onChooseAfter="iQuickSearch1ChooseAfter" onDeleteAfter="iQuickSearch1DeleteAfter" bind_refData='$model.queryBdOrgData.ref("area1Code")'></div></div></div>
  <div class="x-col x-col-10" xid="col10"></div></div>
   ...
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch4" config="org_area" displayAttr="orgName" valueAttr="orgCode" onBeforeQuery="iQuickSearch23BeforeQuery" onDeleteAfter="iQuickSearch23DeleteAfter" bind_refData='$model.queryBdOrgData.ref("area3Code")'></div></div></div><div class="x-col" xid="col5"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit6">
   <label class="x-label" xid="label5" style="text-align:right;padding-right:5px;"><![CDATA[i18n{shop}]]></label>
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch31" bind_refData='$model.queryBdOrgData.ref("storeCode")' config="bd_store" displayAttr="storeName" valueAttr="storeCode" onBeforeQuery="iQuickSearch31BeforeQuery" onDeleteAfter="iQuickSearch33DeleteAfter"></div></div>
  </div>
  <div class="x-col" xid="col3"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit9">
   ...
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch5" onBeforeQuery="iQuickSearch5BeforeQuery" bind_refData='$model.queryUserDate.ref("userCode")' config="bd_user" lazyLoad="true" displayAttr="userName" valueAttr="userCode"></div></div></div>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-info pull-left" label="i18n{nextPage}" xid="button4" bind-click="button4Click">
   ...
   <div class="x-col x-col-33" xid="col4"><p style="margin-top:5px;margin-left:-20px;" xid="p1"><span id="showPage2" xid="span9">1</span>i18n{showPage}<span id="showPageCount2" xid="span10"><![CDATA[?]]></span>i18n{page}
   </p></div></div></div>
