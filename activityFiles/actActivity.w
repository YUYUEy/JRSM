...
<div id="the_window" xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window jrsm-tab-window mdm-popup-edit-window-modified-title mdm-inner-window" component="$UI/system/components/justep/window/window" design="device:pc" style="min-width:1000px">  
  ...
  <div id="row4" component="$UI/system/components/justep/row/row" class="x-row" xid="row4" style="padding:8px 0px 8px 0px;width:1200px;">
   ...
   <input id="start_month" class="form-control date x-iDatetimePicker" component="$UI/system/components/jrsm/iDatetimePicker/iDatetimePicker" xid="iDatetimePicker1" format="YYYY-MM" style="height:26px;" onOkfun="iDatetimePicker1Okfun"></input></div>
  </div>
   ...
   <span xid="span8" style="text-align:center;width:20px;"><![CDATA[~]]></span><input id="end_month" class="form-control date x-iDatetimePicker" component="$UI/system/components/jrsm/iDatetimePicker/iDatetimePicker" xid="iDatetimePicker2" format="YYYY-MM" style="height:26px;" onOkfun="iDatetimePicker2Okfun"></input></div>
  </div>
  ...
  <div class="x-col" xid="col17">
   ...
   <div class="x-col" xid="col27"><span xid="span7" style="margin-top:5px;margin-left:15px;float:left;"><![CDATA[i18n{searchCondition}]]></span><a component="$UI/system/components/justep/button/button" class="btn btn-info btn-only-icon" label="隠す" xid="button1" icon="linear linear-diamond" bind-click="button1Click" style="margin-left:10px;float:left;height:20px;line-height:16px;margin-top:5px;">
   <i id="hide_config" xid="i1" class="linear linear-diamond"></i>
  ...
  <div class="x-col x-col-10" xid="col24"></div></div>
   ...
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch22" bind_refData='$model.queryBdOrgData.ref("area2Code")' config="org_area" displayAttr="orgName" valueAttr="orgCode" onBeforeQuery="iQuickSearch22BeforeQuery" onChooseAfter="iQuickSearch22ChooseAfter" onDeleteAfter="iQuickSearch22DeleteAfter" style="left:4px;width:200px;"></div></div></div><div class="x-col" xid="col6"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit5">
   <label class="x-label" xid="label3" style="text-align:right;padding-right:5px;"><![CDATA[i18n{part2}]]></label>
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch23" bind_refData='$model.queryBdOrgData.ref("area3Code")' config="org_area" displayAttr="orgName" valueAttr="orgCode" onBeforeQuery="iQuickSearch23BeforeQuery" style="left:4px;width:200px;" onDeleteAfter="iQuickSearch23DeleteAfter"></div></div></div><div class="x-col" xid="col13"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit6">
   <label class="x-label" xid="label5" style="text-align:right;padding-right:5px;"><![CDATA[i18n{shop}]]></label>
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch31" bind_refData='$model.queryBdOrgData.ref("storeCode")' config="bd_store" displayAttr="storeName" valueAttr="storeCode" onBeforeQuery="iQuickSearch31BeforeQuery" onDeleteAfter="iQuickSearch33DeleteAfter" style="left:4px;width:200px;"></div></div></div>
  <div class="x-col" xid="col15"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit9">
   ...
   <div class="x-quickSearch" component="$UI/system/components/jrsm/iQuickSearch/iQuickSearch" xid="iQuickSearch32" style="left:4px;width:200px;" onBeforeQuery="iQuickSearch32BeforeQuery" bind_refData='$model.queryUserDate.ref("userCode")' config="bd_user" valueAttr="userCode" displayAttr="userCode" lazyLoad="true"></div></div>
  </div>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-info btn-only-icon pull-right" label="button" xid="button8" icon="icon-ios7-undo" onClick="button8Click" style="margin-right:5px">
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"><ul id="status_type" style="width:410px;">
			<li class="the_triangle">i18n{proposal}<i class="icon iconfont icon-triangle-copy" style="color:#00c;"></i><i class="icon iconfont icon-triangle-copy" style="color:#f0f;"></i></li>
  			<li>i18n{consensus}<i class="icon iconfont icon-yuanxing" style="color:#00c;"></i><i class="icon iconfont icon-yuanxing" style="color:#f0f;"></i></li>
  			<li>i18n{action}<i class="icon iconfont icon-xingxing" style="color:#00c;font-size:14px;"></i><i class="icon iconfont icon-xingxing" style="color:#f0f;font-size:14px;"></i></li>
  			<li style="margin-left:20px;">※<span style="color:#00c;">青色</span>は予定、<span style="color:#f0f;">ピンク</span>は実績</li>
  		</ul><ul id="selectGroup">

  			<li class="small_title">施策</li>
  		</ul><ul id="selectGroup2">
  			<li class="small_title">プロセス管理</li>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-info pull-left" label="i18n{nextPage}" xid="button7" bind-click="button7Click">
   ...
   <div class="x-col x-col-33" xid="col1"><p style="margin-top:5px;margin-left:-10px;">第<span id="showPage">1</span>页，共<span id="showPageCount">?</span>页</p></div></div></div>
