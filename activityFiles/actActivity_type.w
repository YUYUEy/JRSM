...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window jrsm-tab-window" component="$UI/system/components/justep/window/window" design="device:pc">  
  ...
  <column label="操作" name="operation" type="String" xid="xid8"></column>
  <column label="内容" name="typeName" type="String" xid="xid2"></column>
...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   ...
   <div class="x-col" xid="col1"><a component="$UI/system/components/justep/button/button" class="btn btn-info pull-right" label="确定" xid="button2" style="margin-left:2px;" onClick="insertActivityType">
   <i xid="i2"></i>
